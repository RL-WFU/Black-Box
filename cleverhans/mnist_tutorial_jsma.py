...
def mnist_tutorial_jsma(weight_fpath, train_start=0, train_end=60000, test_start=0,
  ...
  model = ModelBasicCNN('model1', nb_classes, nb_filters, weight_fpath)
...
def run_jsma(weight_fpath):
  ...
  mnist_tutorial_jsma(weight_fpath, viz_enabled=FLAGS.viz_enabled,
                      nb_epochs=FLAGS.nb_epochs,
                      batch_size=FLAGS.batch_size,
                      source_samples=FLAGS.source_samples,
                      learning_rate=FLAGS.learning_rate)
